...
<head>
	...
	<title>Delete editor - Bookstore</title>
...
<body>
	<header ><h1>Delete editor</h1></header>
	<section>
	<div class="row-fluid">
      <div class="span6"><h1>Editor List</h1></div>
      <div class="span6">
	...
	<c:forEach items="${editorList}" var="editor">
	<tr>
		<td>
		<c:out  value="${editor.editorId}"/>
		</td>
		<td>
		<c:out  value="${editor.name}"/>
		</td>
		<td>
		<a href="<c:url value="deleteEditor/${editor.name}" />">
